...
const Footer = ({ className = "bg-transparent" }: { className?: string }) => {
  return (
    <footer
      className={`${className} pt-10 md:pt-16 pb-0 relative overflow-hidden`}
    >
        ...
        <div className="bg-white rounded-t-[2.5rem] md:rounded-t-[3.5rem] p-8 md:p-12 lg:p-16 text-black relative shadow-[0_-10px_40px_rgba(0,0,0,0.1)] mx-2 md:mx-6 lg:mx-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 lg:gap-8 relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col items-start">
              ...
              <p className="text-gray-500 text-[13px] leading-relaxed max-w-sm mb-8">
                Manzo is one of the premier wholesale mens fashion
                manufacturers. We specialize in wholesale male clothing and mens
                wear, helping retailers transform their inventory with the best
              ...
              <div className="flex gap-4">
                {[
                  { name: "Twitter", icon: Twitter, href: "#" },
                  {
                    name: "Instagram",
                    icon: Instagram,
                    href: "https://www.instagram.com/manzo_clothing_india_/",
                  },
                  ...
                  <Link
                    key={social.name}
                    href={social.href}
                    className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-50 hover:bg-black hover:text-white transition-all duration-300 text-gray-400"
                  >
            ...
            <div className="lg:col-span-7 grid grid-cols-2 gap-8 md:gap-6 lg:mt-2">
              ...
              <div className="flex flex-col space-y-5">
                <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-black/30">
                  Shop
                </h4>
          ...
          <div className="mt-12 md:mt-18 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[11px] font-bold text-black/20 uppercase tracking-widest">
              &copy; {new Date().getFullYear()} Manzo Clothing. All rights
              reserved.
            </p>
            <div className="flex gap-8">
              <span className="text-[10px] font-black text-black/10 uppercase tracking-tighter">
                Manzo Clothing - Premium Wholesale Manufacturing
              </span>
            </div>
          </div>
        </div>
