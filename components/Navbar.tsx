...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`hidden md:flex items-center transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${showDarkNavbar ? "glass-card px-3 py-2 shadow-2xl translate-y-0" : "px-2 py-1.5 translate-y-[-4px]"}`}
      >
